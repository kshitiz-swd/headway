...
import { deleteApplication, getResume } from "../../api/services";

const ApplicationsTable = ({ applications }) => {
      

    const { openEditApplicationModal } = useOutletContext();
    ...
    return (
        <div className="rounded-lg overflow-visible border-2 border-black">
            ...
            <table className="w-full text-sm ">
                ...
                <thead className="bg-gray-50 border-b border-gray-100 rounded-2xl">
                    <tr>
                        <th className="">
                            <input
                                type="checkbox"
                    ...
                    {applications.map((app) => (
                        <tr
                            ...
                            className={`border-b border-gray-100 hover:bg-gray-50 transition ${
                                selectedRows.includes(app._id) ? "bg-gray-50" : ""
                            }`}
                        >
